  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      EasyStar.js = function() {
              ...
              if (searchNode.x > 0 && searchNode.y > 0) {
                if (
                  ...
                  checkAdjacentNode(
                    ...
                    -1,
                    DIAGONAL_COST *
                      getTileCost(searchNode.x - 1, searchNode.y - 1)
                  );
                }
              }
              if (
        ...
        var calculateDirection = function(diffX, diffY) {
          ...
          throw new Error(
            "These differences are not valid: " + diffX + ", " + diffY
          );
        };

        var getTileCost = function(x, y) {
          return (
            (pointsToCost[y] && pointsToCost[y][x]) ||
            costMap[collisionGrid[y][x]]
          );
        };
    ...
    /***/ function(module, exports, __webpack_require__) {
      var __WEBPACK_AMD_DEFINE_FACTORY__,
        ...
        __WEBPACK_AMD_DEFINE_RESULT__; // Generated by CoffeeScript 1.8.0
      (function() {
        var Heap,
          defaultCmp,
          floor,
